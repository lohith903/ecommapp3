            ...
            steps {
                withCredentials([sshUserPrivateKey(credentialsId: 'f2825fcd-e630-43da-ae1b-f0ebf49cf13e', keyFileVariable: 'SSH_KEY')]) {
                    script {
                        ...
                        bat "icacls C:\\ProgramData\\Jenkins\\.jenkins\\workspace\\ecommapp@tmp\\secretFiles\\4021768b-57af-4637-8944-f2475016b294\\ssh-key-SSH_KEY /GRANT:R "jenkins_user":(R)"
